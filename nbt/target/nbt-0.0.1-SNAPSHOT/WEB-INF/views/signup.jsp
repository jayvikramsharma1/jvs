...
<body>
	<form class="form-signin">
      ...
      <div class="form-label-group">
        <input type="uname" id="inputUName" class="form-control" placeholder="User Name" required autofocus>
      ...
      <div class="form-label-group">
        <input type="password" id="cnfInputPassword" class="form-control" placeholder="Confirm Password" required>
        <label for="cnfInputPassword">Confirm Password</label>
      </div>
